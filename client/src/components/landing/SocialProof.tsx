...
const REVIEWS: Record<string, { name: string; text: string; stars: number; verified: boolean }[]> = {
  ...
  "extra-strength": [
    { name: "David R.", text: "I keep this alongside my Daily Maintenance. When I have a rough weekend or travel, I switch to Extra Strength for a few days. The higher celery seed concentration makes a real difference.", stars: 5, verified: true },
    { name: "Thomas W.", text: "Stronger than the daily version, which is exactly what I needed. I use it during flare-up periods and it helps me get back to normal faster.", stars: 5, verified: true },
  ...
  "now": [
    { name: "Richard P.", text: "This is my emergency bottle. I keep one at home and one in my golf bag. When I feel something coming on, two capsules and I'm usually fine by the next morning.", stars: 5, verified: true },
    { name: "Gary H.", text: "The Chanca Piedra formula is completely different from the other GO-OUT products. It works fast, which is exactly what I need when things flare up unexpectedly.", stars: 5, verified: true },
    { name: "Paul S.", text: "I was skeptical about the 'stone breaker' herb but it delivered. Fast-acting and effective. I use it alongside Daily Maintenance and the combination is solid.", stars: 4, verified: true },
  ],
};
